...
class CPMK5Soal4 extends StatefulWidget {
  const CPMK5Soal4({Key? key}) : super(key: key);

  @override
  State<CPMK5Soal4> createState() => _CPMK5Soal4State();
}

class _CPMK5Soal4State extends State<CPMK5Soal4> {
  answer(abjad) {
    switch (abjad) {
      case 'A':
        return 'A.	Setiap perbuatan buruk yang sengaja saya perbuat, selalu meningglkan penyesalan.';
      case 'B':
        return 'B.	Pasti menyesal, saya masih takut dosa';
      case 'C':
        return 'C.	Menyesal, tapi saya selalu mengulangi hal tersebut;';
      case 'D':
        return 'D.	Terkadang menyesal, terkadang tidak.';
      default:
        return 'Apakah anda pernah menyesal ketika berbuat buruk kepada teman dan dosen anda?';
    }
  }
