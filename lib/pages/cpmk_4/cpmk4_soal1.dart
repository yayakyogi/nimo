...
class CPMK4Soal1 extends StatefulWidget {
  const CPMK4Soal1({Key? key}) : super(key: key);

  @override
  State<CPMK4Soal1> createState() => _CPMK4Soal1State();
}

class _CPMK4Soal1State extends State<CPMK4Soal1> {
  answer(abjad) {
    switch (abjad) {
      case 'A':
        return 'A.	Tidak, saya orangnya mudah memaafkan dan melupakan kesalahan.';
      case 'B':
        return 'B.	Tidak, tapi saya akan menjauhi orang tersebut.';
      case 'C':
        return 'C.	ika dia atau mereka membuat saya trauma, pasti ada dendam di hati saya.';
      case 'D':
        return 'D.	Tentu saja iya, dan saya akan membalasnya di momentum tertentu.';
      default:
        return 'Apakah anda akan dendam kepada seseorang yang telah menyakiti anda?';
    }
  }
